...
function getCurrentCode(){
    ...
    var newCode = 'I00'+(parseInt(lastCode.substr(1))+1);
    return newCode;
}
    ...
    $.ajax({
        ...
        $('tbody tr').click(function () {
            ...
            $('#updateItem').click(function () {
                ...
                if (valid){
                    ...
                    $.ajax({
                        method:"PUT",
                        url:"http://localhost:8080/api/v1/items/"+code.substr(1),
                        async:true,
        ...
        $('tbody tr td:last-child img').click(function () {
            ...
            if (confirm("Do you really want to delete?")){
                ...
                $.ajax({
                    method:"DELETE",
                    url:"http://localhost:8080/api/v1/items/"+d.substr(1),
                    async:true
                }).done(function (data) {
                    ...
                    $('tbody tr').click(function () {
                        ...
                        $('#updateItem').click(function () {
                            ...
                            if (valid){
                                ...
                                $.ajax({
                                    method:"PUT",
                                    url:"http://localhost:8080/item/"+code.substr(1),
                                    async:true,
                                    contentType: 'application/json',
                                    data:JSON.stringify({
                                        description:$('#exampleInputDescription').val(),
