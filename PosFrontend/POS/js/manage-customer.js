function getCurrentCode(){
    ...
    var newCode = 'C00'+(parseInt(lastCode.substr(2,4))+1);
    return newCode;
}
                ...
                $('tbody tr').click(function () {
                    ...
                    $('#updateCustomer').click(function () {
                        ...
                        if (valid){
                            ...
                            $.ajax({
                                method:"PUT",
                                url:"http://localhost:8080/api/v1/customers/"+id.substr(1),
                                async:true,
...
$('#addCustomer').click(function () {
    ...
    if (valid){
        ...
        $.ajax({
            ...
            var currentId = 'C00'+(parseInt(id1.substr(1))+1);
            $('#exampleInputID').val('');
            $('#exampleInputID').val(currentId);
            $('#exampleInputName').val('');
            $('#exampleInputAddress').val('');
            ...
            $('tbody tr:last-child').click(function () {
                ...
                $('#updateCustomer').click(function () {
                    ...
                    if (valid){
                        ...
                        var id = $('tbody tr:last-child td:first-child').text();
                        var currentId = 'C00'+(parseInt(id.substr(1))+1);
                        console.log(currentId);
                        $('#exampleInputID').val('');
                        $('#exampleInputID').val(currentId);
                        $('#exampleInputName').val('');
